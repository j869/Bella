...
--#region Customer Purchase Tracking Table
    ...
    (
        ...
        notes TEXT,                                             -- customer journey tracking
        -- Metadata
    ...
    COMMENT ON COLUMN customer_purchases.notes IS 'Customer journey tracking - a complete story of the customer experience:';
